  ...
  const cases = [
    {
      ...
      stats: [
        ...
        { label: "CTR increased vs non-localized trailers", value: "32%", icon: <BarChart3 className="w-5 h-5 text-blue-500" /> },
        { label: "Higher pre-registration rates in Japan and Korea", value: "✔", icon: <PenLine className="w-5 h-5 text-blue-500" />, isIcon: true }
      ],
            ...
            >
              ...
              <div className="w-full lg:w-1/2 p-8 md:p-14 flex flex-col justify-center">
                ...
                <button 
                  ...
                  className="inline-flex items-center gap-3 border border-blue-400 text-[#0070c0] pl-6 pr-2 py-1.5 rounded-full font-semibold hover:bg-blue-50 transition self-start group"
                >
                  View Case Studies
