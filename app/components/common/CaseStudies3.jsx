    ...
    <section className="overflow-hidden relative mt-0 md:mt-[-200px] z-1 p-4 md:p-0">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start mb-16 gap-6 container mx-auto">
        ...
        <div className="md:max-w-lg pt-4 md:pt-14 text-left">
          ...
          >
            From large-scale game launches to multilingual animation dubbing, HS+ delivers measurable production results across languages, timelines, and markets.
          </p>
        </div>
      </div>
