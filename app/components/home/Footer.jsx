    ...
    <footer className="bg-white pt-20">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="flex gap-3 mb-10">
              {[Twitter, Linkedin, Youtube, Globe, Facebook].map((Icon, i) => (
                <div key={i} className="w-10 h-10 bg-[#0070c0] rounded-full flex items-center justify-center text-white cursor-pointer hover:bg-blue-700 transition shadow-md">
        ...
        <div className="py-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-gray-400">
          <p>All Rights Reserved. <br className="md:hidden" /> Designed by HANSI TRANS+ | Powered by</p>
