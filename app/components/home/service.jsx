      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col justify-center bg-[#F7F7F7] mb-20">
        <div className="container mx-auto px-4">
          ...
          <div
            ...
            style={{
              height: "clamp(650px, 80vh, 550px)", // Increased height for mobile to fit image
            }}
          >
            {services.map((service, index) => {
              ...
              const y = useTransform(smoothProgress, [start, end], [index === 0 ? 0 : 610, 0]);
              ...
              return (
                ...
                >
                  <div
                    ...
                    className="rounded-[30px] md:rounded-[70px] shadow-md md:shadow-[0_20px_50px_rgba(0,0,0,0.1)] border-b border-white/40 overflow-hidden h-full"
                  >
                    <div className="p-6 md:p-14 flex flex-col lg:flex-row items-center gap-5 md:gap-10 h-full overflow-hidden touch-auto md:overflow-hidden">
                      ...
                      <div className="w-full lg:w-1/2 flex flex-col justify-center">
                        ...
                        {/* Key features */}
                        <div className="block space-y-3 mb-6 md:mb-10">
                          <h4
                            style={{
                              color: "#090E2F",
                              fontFamily: "Poppins, sans-serif",
                        ...
                        <Link
                          href="/services"
                          className="group inline-flex items-center justify-center transition-all duration-300 whitespace-nowrap rounded-[100px] flex-shrink-0 self-start mb-6 md:mb-0"
                          style={{
                            height: "44px",
                      ...
                      {/* Image side - Now visible on mobile below the text */}
                      <div className="w-full lg:w-1/2 h-[200px] md:h-full shrink-0">
                        <div className="relative rounded-[20px] md:rounded-[55px] overflow-hidden h-full shadow-md">
                          <img
                            src={service.image}
                            alt={service.title}
...
const Service = () => {
  ...
  if (!hasHydrated) return <div className="min-h-screen bg-[#F7F7F7]" />;
