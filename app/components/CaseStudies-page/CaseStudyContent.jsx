      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-16">
          {stats.slice(0, 2).map((stat, index) => (
            <div
              key={index}
              className="bg-white border border-gray-100 rounded-2xl py-8 text-center shadow-sm"
            >
              <h2 className="text-4xl font-bold text-[#0066b2] mb-1">
                {stat.value}
              </h2>
